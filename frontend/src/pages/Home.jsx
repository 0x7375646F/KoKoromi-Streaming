...
const Home = () => {
  ...
  return (
    <div className="relative">
      <Helmet>
        <title>
          Watch Anime Online, Free Anime Streaming Online on kokoromi Anime
          Website
        </title>
        <meta
          name="description"
          content="Kokoromi is an anime site to watch anime. Online anime streaming at Kokoromi with DUB, SUB in HD"
        />
        <meta property="og:title" content="home - Kokoromi" />
      </Helmet>
      {isLoading ? (
