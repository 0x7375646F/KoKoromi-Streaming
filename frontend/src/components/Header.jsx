...
import { FaArrowCircleRight, FaBars, FaSearch, FaUser, FaCrown } from "react-icons/fa";
...
const getEffectiveProfilePic = (user) => {
  return user?.pfp || user?.picture || '/default-avatar.svg';
};
...
const Header = () => {
  ...
  return (
    <div className="relative z-[100]">
      <div className="fixed bg-card w-full py-2 top-0">
        <div className="flex gap-2 px-5 md:px-10 md:gap-5 justify-between items-center">
          <div className="left flex gap-2 md:gap-5 items-center">
            <div className="menu z-[101] relative" onClick={sidebarHandler}>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <img
                    ...
                    className="w-8 h-8 rounded-full object-cover border-2 border-gray-600 hover:border-primary transition-colors cursor-pointer"
